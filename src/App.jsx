...
function App() {
  useEffect(() => {
    const scripts = [
      { src: '/js/entryScene.js', type: 'module', id: 'script-entry-scene' },
      { src: '/js/hero.js', id: 'script-hero' },
      { src: '/js/hero-accessibility.js', id: 'script-hero-a11y' },
      { src: '/js/searchBar.js', id: 'script-searchbar' },
      { src: '/js/scrollbar.js', id: 'script-scrollbar' },
      { src: '/js/snowEffect.js', id: 'script-snow-effect' },
    ];

    scripts.forEach(({ src, type, id }) => {
